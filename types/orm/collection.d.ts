...
/**
 ...
 @public
 */
export default class Collection<T extends {}, ElementType extends ModelInstance<T> = ModelInstance<T>> {
    /**
     ...
     */
    get length(): number;
    update<K extends keyof T>(key: K & string, val: T[K]): this;
    /**
    ...
    /**
     ...
     @public
     */
    sort(f: (a: T, b: T) => number): Collection<T, ElementType>;
    /**
    ...
    /**
     ...
     @public
     */
    mergeCollection(collection: Collection<T, ElementType>): this;
    /**
